  ...
  if (contacts.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        <button 
          onClick={() => onAddContact({ peerId: '' })}
          className="px-6 py-2.5 rounded-lg bg-[#00f3ff]/10 border border-[#00f3ff]/40 text-[#00f3ff] text-xs font-bold uppercase tracking-wide hover:bg-[#00f3ff]/20 transition-all flex items-center gap-2"
        >
          <UserPlus className="w-4 h-4" />
          Add Contact
        </button>
